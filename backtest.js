/* Drift Calc — the doorway to the backtest page, plus copy tightening.
   The backtester lives at backtest.html so this page stays about one job.
   Styling for all of it is in polish.css. */
(function () {
'use strict';
...
/* sits right under the dashboard, where someone looking at their allocation
   is most likely to wonder how it would have held up */
