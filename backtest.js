...
(function groupExtras() {
  ...
  /* Cards inside "What if" that have a standalone page of their own get the link on
     the card rather than the group heading. */
  [['waitBody', '/waiting.html'], ['plannerBody', '/savings.html']].forEach(function (pair) {
    var host = document.getElementById(pair[0]);
    var card = host && host.closest ? host.closest('.card') : null;
