  ...
  el.innerHTML =
    ...
    '<details class="acc"><summary>What is &ldquo;interest above T-bills&rdquo;?<span class="hint">and which fund you would actually buy</span></summary><div class="accbody">' +
      ...
      '<table style="margin-bottom:14px">' +
        ...
        '<tr><td><b>2&ndash;5%</b></td><td style="text-align:left" class="dim">Ordinary margin at Schwab, Fidelity, E*TRADE, Robinhood. What most people can actually get, and where the math stops working. Drag the slider there and watch the peak collapse toward 1x.</td></tr>' +
      '</table>' +
